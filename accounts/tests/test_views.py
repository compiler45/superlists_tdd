...
class SendLoginEmailView(TestCase):
    ...
    def test_redirect_to_home_page_on_post(self):
    ...
    def test_sends_mail_to_address_from_post(self, mock_send_mail):
        ...
        self.assertEqual(to_list, ['lain@example.com'])
    ...
    def test_sends_link_to_login_using_token_uid(self, mock_send_mail):
        ...
        (subject, body, from_email, subject), kwargs = mock_send_mail.call_args
    ...
    def test_creates_token_associated_with_email(self):
        ...
        token = Token.objects.first()
        self.assertEqual(token.email, 'lain@example.com')
