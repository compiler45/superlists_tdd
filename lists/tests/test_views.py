...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # setup POST data ourselves, rather than using the integrated Django Test Client
    ...
    def test_redirects_to_form_returned_object_if_form_valid(
        ...
        mock_list_obj = mock_form.save.return_value
        mock_redirect.assert_called_once_with(
            str(mock_list_obj.get_absolute_url.return_value)
        )
